...
import com.bootios.alone.global.advice.exception.CSocialAgreementException;
...
public class SignController {
    ...
    public SingleResult<TokenDto> loginByKakao(
        ...
        User user = userRepository.findByEmailAndProvider(kakaoProfile.getKakao_account().getEmail(), "kakao")
